...
$products = [
    [
        'image' => 'assets/img/HF10.jpeg',
        'alt' => ' robe',
        'name' => 'Robe',
        'price' => '8 000 FCFA',
    ],
    [
        'image' => 'assets/img/HF2.jpeg',
        'alt' => 'Ensemble chemise et pantalon',
        'name' => 'Ensemble chemise et pantalon',
        'price' => '6 000 FCFA',
    ],
    [
        'image' => 'assets/img/HF3.jpeg',
        'alt' => 'Ensemble robe et manteau',
        'name' => 'Ensemble robe et manteau',
        'price' => '6 000 FCFA',
    ],
    [
        'image' => 'assets/img/HF14.jpeg',
        'alt' => 'Robe  ',
        'name' => 'Robe et menteau',
        'price' => '7 000 FCFA',
        
    ],
    [
        'image' => 'assets/img/HF6.jpeg',
        'alt' => 'Image a ajouter',
        'name' => 'Ensemble ',
        'price' => '6 500 FCFA',
    ...
    [
        'image' => 'assets/img/HF9.jpeg',
        'alt' => 'Image a ajouter',
        'name' => 'Robe avec Foulard',
        'price' => '6 000 FCFA',
        
    ],
    [
        'image' => 'assets/img/HF16.jpeg',
        'alt' => 'Image a ajouter',
        'name' => 'Ensemblr',
        'price' =>'7 000 FCFA',
...
<head>
    ...
    <style>
        ...
        .hero-card {
            background: linear-gradient(135deg, rgba(255, 255, 255, 0.95), rgba(231, 240, 255, 0.88));
            border-radius: 28px;
            box-shadow: var(--shadow-soft);
            padding: 2.5rem;
        }

        .theme-vetements .hero-card {
            background-image: linear-gradient(135deg, rgba(255, 255, 255, 0.94), rgba(231, 240, 255, 0.84)), url('<?= base_url('assets/img/HF2.jpeg') ?>');
        ...
        .card-placeholder {
            ...
            padding: 1.5rem;
            background: linear-gradient(135deg, rgba(31, 107, 255, 0.08), rgba(17, 71, 183, 0.12));
            color: var(--text-muted);
            font-weight: 700;
            text-align: center;
            border-bottom: 1px dashed rgba(17, 71, 183, 0.18);
        }
        ...
        .admin-upload-form {
            ...
            border-radius: 18px;
            padding: 1.25rem;
            box-shadow: 0 12px 28px rgba(17, 71, 183, 0.18);
        ...
        .admin-upload-form input {
            border-radius: 999px;
            border-color: rgba(17, 71, 183, 0.3);
        }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link active" href="<?= base_url('vetements') ?>">Vetements</a>
