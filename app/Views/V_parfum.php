...
$products = [
    ...
    [
        'image' => 'assets/img/P2.jpeg',
        'alt' => 'Jean Lowe noir',
        'name' => 'Jean Lowe noir',
        'price' => '8 000 FCFA',
    ],
    [
        'image' => 'assets/img/blue_chanel.jpg',
        'alt' => 'Blue Chanel',
        'name' => 'Blue Chanel',
        'price' => '6 000 FCFA',
    ],
    [
        'image' =>' assets/img/P3.jpeg',
        'alt' => 'Image a ajouter',
...
<head>
    ...
    <style>
        :root {
            ...
            --text-main: #561824;
            --text-muted: #8e4e5c;
            --shadow-soft: 0 18px 40px rgba(123, 34, 51, 0.12);
            --shadow-card: 0 14px 32px rgba(86, 24, 36, 0.12);
        }

        body {
            background:
                radial-gradient(circle at top left, rgba(201, 72, 101, 0.16), transparent 28%),
                linear-gradient(180deg, #fdf9fa 0%, var(--page-bg) 100%);
            color: var(--text-main);
        }

        .navbar {
            background: linear-gradient(135deg, var(--nav-bg), #5b1623) !important;
            box-shadow: 0 10px 28px rgba(91, 22, 35, 0.28);
        }
        ...
        .hero-card {
            background-image: linear-gradient(135deg, rgba(255, 255, 255, 0.95), rgba(249, 232, 236, 0.85)), url('<?= base_url('assets/img/blue_chanel.jpg') ?>');
        ...
        .card:hover {
            ...
            box-shadow: 0 22px 42px rgba(86, 24, 36, 0.18);
        }
        ...
        .card-placeholder {
            ...
            padding: 1.5rem;
            background: linear-gradient(135deg, rgba(201, 72, 101, 0.08), rgba(91, 22, 35, 0.12));
            color: var(--text-muted);
            font-weight: 700;
            text-align: center;
            border-bottom: 1px dashed rgba(91, 22, 35, 0.18);
        }
        ...
        .admin-upload-form {
            ...
            border-radius: 18px;
            padding: 1.25rem;
            box-shadow: 0 12px 28px rgba(91, 22, 35, 0.18);
        ...
        .admin-upload-form input {
            border-radius: 999px;
            border-color: rgba(91, 22, 35, 0.3);
        }
        ...
        .btn-success {
            background: linear-gradient(135deg, var(--primary), #ec6a87);
            border: 0;
        }

        footer {
            border-top: 1px solid rgba(201, 72, 101, 0.12);
        }
    </style>
</head>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link active" href="<?= base_url('parfum') ?>">Parfum</a>
