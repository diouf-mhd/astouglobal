...
$products = [
    [
        'image' => 'assets/img/HF4.jpeg',
        'alt' => 'Jalabe modele 1',
        'name' => 'Ensemble chemise et robe',
        'price' => '9 000 FCFA',
    ],
    [
        'image' => 'assets/img/HF4.jpeg',
    ...
    [
        'image' => 'assets/img/dialabe.jpeg',
        'alt' => 'Jalabe modele 3',
        'name' => 'Jalabe',
        'price' => '6 000 FCFA',
    ],
    [
        'image' => 'assets/img/JB19.jpeg',
        'alt' => 'Image a ajouter',
        'name' => 'Jalabé model ',
        'price' => '11 000 FCFA',
...
<head>
    ...
    <style>
        :root {
            ...
            --text-main: #274615;
            --text-muted: #65844e;
            --shadow-soft: 0 18px 40px rgba(58, 107, 28, 0.12);
            --shadow-card: 0 14px 32px rgba(39, 70, 21, 0.12);
        }

        body {
            background:
                radial-gradient(circle at top left, rgba(94, 157, 47, 0.16), transparent 28%),
                linear-gradient(180deg, #fbfdf8 0%, var(--page-bg) 100%);
            color: var(--text-main);
        }

        .navbar {
            background: linear-gradient(135deg, var(--nav-bg), #284c12) !important;
            box-shadow: 0 10px 28px rgba(40, 76, 18, 0.28);
        }
        ...
        .hero-card {
            background-image: linear-gradient(135deg, rgba(255, 255, 255, 0.95), rgba(236, 245, 228, 0.85)), url('<?= base_url('assets/img/jalabe2.jpg') ?>');
        ...
        .card:hover {
            ...
            box-shadow: 0 22px 42px rgba(39, 70, 21, 0.18);
        }
        ...
        .card-placeholder {
            ...
            padding: 1.5rem;
            background: linear-gradient(135deg, rgba(94, 157, 47, 0.08), rgba(40, 76, 18, 0.12));
            color: var(--text-muted);
            font-weight: 700;
            text-align: center;
            border-bottom: 1px dashed rgba(40, 76, 18, 0.18);
        }
        ...
        .admin-upload-form {
            ...
            border-radius: 18px;
            padding: 1.25rem;
            box-shadow: 0 12px 28px rgba(40, 76, 18, 0.18);
        ...
        .admin-upload-form input {
            border-radius: 999px;
            border-color: rgba(40, 76, 18, 0.3);
        }
        ...
        .btn-success {
            background: linear-gradient(135deg, var(--primary), #82c54d);
            border: 0;
        }

        footer {
            border-top: 1px solid rgba(94, 157, 47, 0.12);
        }
    </style>
</head>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            <div class="navbar-nav ms-auto">
                ...
                <a class="nav-link active" href="<?= base_url('jalabe') ?>">Jalabe</a>
